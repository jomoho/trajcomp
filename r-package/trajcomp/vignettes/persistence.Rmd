...
#curve plot
curve <- PersistenceCurve(as.matrix(traj))
...
bars <- Persistence_TestBars(alpha)
...
pruned <- PersistenceBeta(as.matrix(traj), 0)
...
pruned <- PersistenceBeta(as.matrix(traj), 2)
plot(pruned, col="black", pch=21,
  main="beta = 2",
  xlab="x-axis",
  ylab="y-axis")
...
pruned <- PersistenceBeta(as.matrix(traj), 4)
plot(pruned, col="black", pch=21,
  main="beta = 4",
  xlab="x-axis",
  ylab="y-axis")
...
pruned <- PersistenceBeta(as.matrix(traj), 8)
plot(pruned, col="black", pch=21,
  main="beta = 8",
  xlab="x-axis",
  ylab="y-axis")
...
pruned <- PersistenceBeta(as.matrix(traj), 16)
plot(pruned, col="black", pch=21,
  main="beta = 16",
  xlab="x-axis",
  ylab="y-axis")
...
Here is a selection of results for the different flavors of simplification offered:
...
for(i in 1:128){
  ...
  psb<- PersistenceBeta(as.matrix(traj), 8)
