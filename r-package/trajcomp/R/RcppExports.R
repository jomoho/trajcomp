...
PersistenceCurve <- function(T) {
    .Call('trajcomp_PersistenceCurve', PACKAGE = 'trajcomp', T)
}

PersistenceBeta <- function(T, Beta = 0L) {
    .Call('trajcomp_PersistenceBeta', PACKAGE = 'trajcomp', T, Beta)
}
...
PersistenceSDS <- function(T, Beta, Epsilon, Iterations = 3L) {
    .Call('trajcomp_PersistenceSDS', PACKAGE = 'trajcomp', T, Beta, Epsilon, Iterations)
}

Persistence_TestBars <- function(T) {
    .Call('trajcomp_Persistence_TestBars', PACKAGE = 'trajcomp', T)
}

Persistence_TestComps <- function(T, it = -1L) {
    .Call('trajcomp_Persistence_TestComps', PACKAGE = 'trajcomp', T, it)
}
